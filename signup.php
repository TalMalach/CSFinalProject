...
$message .= "http://noteme.thecompletewebhosting.com/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'talmalach@gmail.com')){
       echo "<div class='alert alert-success'>Thank for your registring Pick A Trip website. A confirmation email has been sent to $email. Please click on the activation link to activate your account.</div>";
